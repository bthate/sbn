...
from sbn.brokers import objs
from sbn.message import Message
from sbn.objects import Object, construct, keys
from sbn.repeats import Repeater
from sbn.timings import elapsed
...
def cbnow(_evt):
    ...
    txt += "https://pypi.org/project/sbn"
