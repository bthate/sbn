...
from sbn.objects import Object, items, keys, update, values
from sbn.methods import fmt, fqn
...
class TestObject(unittest.TestCase):
    ...
    def test_module(self):
        self.assertEqual(Object().__module__, "sbn.objects")

    def test_fqn(self):
        self.assertEqual(fqn(Object()), "sbn.objects.Object")
